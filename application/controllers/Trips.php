...
class Trips extends CI_Controller
{
	...
	// 		}
	// 		if ($response) {
	// 			$this->session->set_flashdata('success', 'Trip added successfully.');
	// 		} else {
	// 			$this->session->set_flashdata('error', 'Failed to add trip.');
	// 		}
	// 		redirect('Trips');
	// 	} else {
	...
	// public function updatetrips()
	// {
	// 	$this->load->model('TripModel'); // Load the model
	// 	$trip_id = $this->input->post('t_id');
	// 	$data = [
	// 		't_customer_id' => $this->input->post('t_customer_id'),
	// 		't_vechicle' => $this->input->post('t_vechicle'),
	// 		't_driver' => $this->input->post('t_driver'),
	...
	// 	$result = $this->TripModel->updateTrip($trip_id, $data);

	// 	if ($result) {
	// 		$this->session->set_flashdata('success', 'Trip updated successfully.');
	// 	} else {
	// 		$this->session->set_flashdata('error', 'Failed to update trip.');
	// 	}
	// 	redirect('Trips/edittrip/' . $trip_id); // Redirect back to the form or success page
	// }
