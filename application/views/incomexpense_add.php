            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-3">
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="ie_date" name="ie_date" value="<?php echo (isset($incomexpensedetails)) ? $incomexpensedetails[0]['ie_date'] : '' ?>" placeholder="Income/Expense">
