...
<section class="content">
   <div class="container-fluid">
      <form method="post" id="vehicle_report" class="card basicvalidation" action="<?php echo base_url();?>reports/vehicles">
         <div class="card-body">
            <div class="row">
               <!-- <div class="col-md-3">
               ...
               <input type="hidden" id="vehicle_report" name="vehicle_report" value="1">
               <div class="col-md-2">
