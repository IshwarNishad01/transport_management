    ...
    <section class="content">
       <div class="container-fluid">
          <form method="post" id="myForm" class="card" action="<?php echo base_url('Trips/inserttrips'); ?>">
                ...
                <div class="row">
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" value="" name="t_trip_fromlocation" id="t_trip_loading" class="form-control" placeholder="Trip Start Location">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" value="" name="t_trip_tolocation" id="t_trip_location" class="form-control" placeholder="Trip End Location">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" value="" name="t_source" id="t_source" class="form-control" placeholder="Trip Source">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" value="" name="t_commodity" id="t_commodity" class="form-control" placeholder="Trip Commodity">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" value="" name="t_quantity" id="t_quantity" class="form-control" placeholder="Trip Quantity">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" value="" name="t_totaldistance" id="t_totaldistance" class="form-control" placeholder="Approx Total KM">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="date" value="" name="t_start_date" value="" class="form-control" placeholder="Trip Start Date">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="date" value="" name="t_end_date" value="" class="form-control" placeholder="Trip End Date">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="inlineCheckboxOptions" id="inlineCheckbox1" value="option1" onclick="limitCheckboxSelection(this)">
                            <label class="form-check-label" for="inlineCheckbox1">Coal</label>
                         </div>

                         <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="inlineCheckboxOptions" id="inlineCheckbox2" value="option2" onclick="limitCheckboxSelection(this)">
                            <label class="form-check-label" for="inlineCheckbox2">Fly Ash</label>
                         </div>

                         <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="inlineCheckboxOptions" id="inlineCheckbox3" value="option3" onclick="limitCheckboxSelection(this)">
                            <label class="form-check-label" for="inlineCheckbox3">Gitti</label>
                         </div>

                         <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="inlineCheckboxOptions" id="inlineCheckbox3" value="option3" onclick="limitCheckboxSelection(this)">
                            <label class="form-check-label" for="inlineCheckbox3">Sand</label>
                         </div>
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" value="" name="t_trip_amount" value="" class="form-control" placeholder="Enter Weight">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" value="" name="t_trip_amount" value="" class="form-control" placeholder="Fuel Consumer Per Trip">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" value="" name="t_trip_amount" value="" class="form-control" placeholder="Enter Meter Reading">
                      </div>
                   </div>
                   ...
                   <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                         ...
                         <input type="text" value="" name="t_trip_amount" value="" class="form-control" placeholder="Enter Rate Of Transportation">
                      </div>
                   </div>
    ...
    <script>
       ...
       $('#myForm').submit(function(e) {
          ...
          $.ajax({
             url: '<?= base_url('Trips/inserttrips') ?>',
             type: 'POST',
             data: formData,
             success: function(response) {
                try {
                   const jsonResponse = JSON.parse(response); // Parse response if it's JSON
                   if (jsonResponse.success) {
                      alert('Trip added/updated successfully!');
                      // Redirect to Trips page
                      window.location.href = '<?= base_url('trips') ?>';
                   } else {
                      alert('Error: ' + jsonResponse.message); // Display server-side error
                   }
                } catch (error) {
